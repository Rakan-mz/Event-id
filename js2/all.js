...
let questions = [{
    numb: 1,
    question: "What does Windows event ID 5140 indicate ?",
    answer: "A network share object was accessed",
    options: [
        "A network share object was deleted",
        "A network share object was changed",
        "A network share object was accessed",
        "A network share object was created"
    ]
},
{
    numb: 2,
    question: "What does Windows event ID 5142 indicate ?",
    answer: "A network share object was created",
    options: [
        "A network share object was created",
        "A network share object was changed",
        "A network share object was accessed",
...
{
    numb: 3,
    question: "What does Windows event ID 5143 indicate ?",
    answer: "A network share object was changed",
    options: [
        "A network share object was accessed",
        "A network share object was created",
        "A network share object was deleted",
...
{
    numb: 4,
    question: "What does Windows event ID 5144 indicate ?",
    answer: "A network share object was deleted",
    options: [
        "A network share object was changed",
        "A network share object was deleted",
        "A network share object was accessed",
...
{
    numb: 5,
    question: "What does Windows event ID 5145 indicate ?",
    answer: "A network share object was checked to see whether client can be granted desired access",
    options: [
...
{
    numb: 6,
    question: "What does Windows event ID 5156 indicate ?",
    answer: "The Windows Filtering Platform has permitted a connection",
    options: [
...
{
    numb: 16,
    question: "What does Windows event ID 4624 indicate ?",
...
{
    numb: 18,
    question: "What does Windows event ID 4656 indicate ?",
    answer: "A user tries to access the'Registry' key",
    options: [
        "The 'Registry' key value was changed",
        "'Registry' key or value or File was deleted",
        "A user tries to access the'Registry' key",
        "Details about operation on File"
    ]
},
{
    numb: 19,
    question: "What does Windows event ID 4657 indicate ?",
    answer: "The 'Registry' key value was changed",
    options: [
        "Details about operation on File",
        "Registry' key or value or File was deleted'",
        "A user tries to access the'Registry' key",
...
{
    numb: 20,
    question: "What does Windows event ID 4660 indicate ?",
    answer: "Registry' key or value or File was deleted'",
    options: [
        "Details about operation on File",
        "Registry' key or value or File was deleted'",
        "A user tries to access the'Registry' key",
...
{
    numb: 21,
    question: "What does Windows event ID 4663 indicate ?",
    answer: "Details about operation on File",
    options: [
        "Details about operation on File",
        "Registry' key or value or File was deleted'",
        "A user tries to access the'Registry' key",
...
{
    numb: 22,
    question: "What does Windows event ID 4688 indicate ?",
    answer: "A new process being created",
    options: [
        "Details about operation on File",
