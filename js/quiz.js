...
function removeCanvas(){
    ...
    document.body.style.background = "#53535b";
    document.getElementById('start').style.backgroundColor = "white";
    document.querySelector("#container > div.grid").style.backgroundColor = "white";
    document.querySelector("#quiz > div.div1 > h1").style.color = "#212529";
}
